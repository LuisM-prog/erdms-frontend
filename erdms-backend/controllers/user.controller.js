...
// CREATE new user (Admin only) - auto generates password
        ...
        db.query(
            ...
            (err, result) => {
                ...
                res.status(201).json({
                    ...
                    temporary_password: tempPassword  // Admin sees this once
                });
            }
        );
    });
...
// UPDATE user (Admin only) - name, email, role_id, status only (NO password here)
